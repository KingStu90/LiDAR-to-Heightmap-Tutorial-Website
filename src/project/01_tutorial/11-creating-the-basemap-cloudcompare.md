...
As shown in the photos below, **PDAL IDW interpolation may leave areas with no nearby points unfilled**, whereas CloudCompare **Kriging can estimate values across larger gaps using surrounding points**.
