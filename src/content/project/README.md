...
The complete **project files** used for this tutorial are available on GitHub. The repository includes **scripts for each step of the workflow**, as well as a `downloadlist.txt` containing the data used in the tutorial, so you can reproduce the workflow using the same source data or use your own data. You can follow along by copying the commands provided and executing them as you work through the tutorial. The workflow can be run either **natively on your computer** or using **Docker**. [**View the project repository**](https://github.com/KingStu90/LiDAR-to-Heightmap-Beginner-Tutorial).
